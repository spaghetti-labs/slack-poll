...
export class AddUserIdColumnInPollTable1638098141565 implements MigrationInterface {
    name = 'AddUserIdColumnInPollTable1638098141565'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "temporary_poll" ("id" varchar PRIMARY KEY NOT NULL, "user_id" varchar NOT NULL)`);
        await queryRunner.query(`INSERT INTO "temporary_poll"("id") SELECT "id" FROM "poll"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`INSERT INTO "poll"("id") SELECT "id" FROM "temporary_poll"`);
